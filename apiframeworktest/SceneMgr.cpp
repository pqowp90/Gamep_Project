...
void SceneMgr::Init()
{
	...
	m_arrScene[(UINT)SCENE_TYPE::ScenePlayerTest] = new ScenePlayerTest;
	m_arrScene[(UINT)SCENE_TYPE::ScenePlayerTest]->SetName(L"ScenePlayerTest");
...
//	m_arrScene[(UINT)SCENE_TYPE::SCENE_02] = new Scene02;
	...
	// 현재 씬 지정
	m_pCurScene = m_arrScene[(UINT)SCENE_TYPE::ScenePlayerTest];
	m_pCurScene->Enter();
}
